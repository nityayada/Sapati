                ...
                <div class="editorial-grid">
                    ...
                    <section>
                            ...
                            <div style="display: flex; align-items: center; gap: 0.5rem;">
                                <c:choose>
                                    <c:when test="${item.status.equalsIgnoreCase('Listed')}">
                                        ...
                                        <c:set var="detIcon" value="panding" />
                                    </c:when>
                        ...
                        <div class="description-quote">
                            "${not empty item.description ? item.description : 'No additional specifications provided for this community resource.'}"
                        </div>
                            ...
                            <ul class="rules-list">
                                <li>
                                    ...
                                    <div>
                                        ...
                                        <div style="font-size: 0.875rem; color: var(--on-surface-variant);">${item.itemCondition}</div>
                                    </div>
                                </li>
                                <li>
                            ...
                            <c:choose>
                                ...
                                <c:when test="${item.status.equalsIgnoreCase('Available')}">
                                    <c:if test="${not empty param.error}">
                                        <div class="auth-msg auth-msg-error" style="margin-bottom: 2rem;">${param.error}</div>
                                    </c:if>
