            ...
            <main class="container" style="padding: 6rem 1.5rem;">
                ...
                <section class="welcome-banner" style="margin-bottom: 4rem;">
                    <div class="user-avatar"
                        style="width: 100px; height: 100px; background-color: var(--primary-container); border: 2px solid var(--primary); overflow: hidden; display: flex; align-items: center; justify-content: center;">
                        <c:choose>
                    ...
                    <div>
                        <div style="display: flex; align-items: baseline; gap: 1.5rem; margin-bottom: 0.75rem;">
                            <h1
                                style="font-size: 3rem; font-weight: 900; line-height: 1; text-transform: uppercase; letter-spacing: -0.04em;">
                                Member Registry</h1>
                        </div>
                        <div style="display: flex; gap: 2rem; align-items: center;">
                            <span class="status-chip"
                                style="background-color: var(--primary); color: white; border: none;">NODE_${user.userId}</span>
                            <p
                                style="font-size: 0.8125rem; color: var(--outline); font-weight: 500; text-transform: uppercase; letter-spacing: 0.1em;">
                ...
                <c:if test="${param.msg eq 'profile_updated'}">
                    <div
                        style="background-color: #E8F5E9; border-left: 5px solid #2E7D32; padding: 1.5rem; margin-bottom: 3rem; font-weight: 700; font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.1em; color: #1B5E20;">
                ...
                <c:if test="${param.msg eq 'security_updated'}">
                    <div
                        style="background-color: #E3F2FD; border-left: 5px solid #1976D2; padding: 1.5rem; margin-bottom: 3rem; font-weight: 700; font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.1em; color: #0D47A1;">
                ...
                <c:if test="${not empty error}">
                    <div
                        style="background-color: #FFEBEE; border-left: 5px solid #C62828; padding: 1.5rem; margin-bottom: 3rem; font-weight: 700; font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.1em; color: #B71C1C;">
                        ${error}
                    </div>
                </c:if>
                ...
                <div class="dashboard-grid" style="grid-template-columns: 1.5fr 1fr; gap: 4rem;">
                    ...
                    <section style="background-color: white; border: 1px solid var(--outline-variant); padding: 3rem;">
                        <h2 class="label-md"
                            style="margin-bottom: 3rem; border-bottom: 2px solid var(--primary); padding-bottom: 1rem; display: inline-block;">
                            IDENTITY_REGISTRY_v1.0</h2>
                        ...
                        <form action="${pageContext.request.contextPath}/user" method="POST"
                            ...
                            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name" class="filter-input" value="${user.fullName}"
                                        required style="width: 100%; border-color: var(--outline-variant);">
                                </div>
                                <div class="form-group">
                                    <label class="filter-label">Email Access (Read-Only)</label>
                                    <input type="email" class="filter-input" value="${user.email}" disabled
                                        style="width: 100%; background-color: var(--surface-container-lowest); opacity: 0.6;">
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-8">
                                <label class="label-md" style="color: var(--outline);">UPDATE PROFILE IDENTITY
                                    IMAGE</label>
                            ...
                            <button type="submit" class="btn btn-primary"
                                style="padding: 1.5rem 4rem; font-size: 0.8125rem; letter-spacing: 0.2em; margin-top: 2rem;">COMMIT
                                CHANGES</button>
                        </form>
                    </section>
                    ...
                    <aside class="space-y-12">
                        ...
                        <section
                            style="background-color: white; border: 1px solid var(--outline-variant); padding: 3rem;">
                            <h2 class="label-md"
                                style="margin-bottom: 2rem; border-bottom: 1px solid var(--outline-variant); padding-bottom: 1rem;">
                                SECURITY_PROTOCOLS</h2>
                            ...
                            <form action="${pageContext.request.contextPath}/user" method="POST" class="space-y-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="new_password" class="filter-input" required
                                        style="width: 100%; border-color: var(--outline-variant);">
                                </div>

                                <div class="form-group" style="margin-bottom: 1.5rem;">
                                    <label class="filter-label">Confirm Key</label>
                                    <input type="password" name="confirm_password" class="filter-input" required
                                        style="width: 100%; border-color: var(--outline-variant);">
                                </div>

                                <button type="submit" class="btn btn-ghost"
                                    style="width: 100%; border: 2px solid var(--primary); padding: 1.25rem; font-size: 0.75rem; letter-spacing: 0.1em; background-color: transparent;">UPDATE
                                    CREDENTIALS</button>
                            </form>
                        </section>

                        <section
                            style="background-color: var(--surface-container-low); padding: 2rem; border: 1px solid var(--outline-variant);">
                            ...
                            <div style="font-family: 'Inter', sans-serif; font-size: 0.75rem; line-height: 2;">
                                ...
                                <div style="display: flex; justify-content: space-between;">
                                    ...
                                    <span
                                        style="font-weight: 900; color: var(--primary);">${user.role.toUpperCase()}_ACCESS</span>
                                </div>
                                <div
                                    style="display: flex; justify-content: space-between; margin-top: 1rem; padding-top: 1rem; border-top: 1px dashed var(--outline-variant);">
                                    <span style="font-weight: 700; color: var(--error);">DANGER_ZONE</span>
                                    <a href="#"
                                        style="color: var(--error); font-weight: 900; text-decoration: underline;">DEACTIVATE_ACCOUNT</a>
                                </div>
                            </div>
                        </section>
