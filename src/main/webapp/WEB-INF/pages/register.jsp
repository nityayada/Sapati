            ...
            <main class="auth-main" style="padding: 4rem 2rem;">
                <div class="split-layout">
                    ...
                    <div class="split-branding">
                        <div>
                            <span class="label-md" style="color: var(--on-primary); opacity: 0.7;">Node Registration
                                v1.0</span>
                            <h1 style="color: var(--on-primary); font-size: 3.5rem; line-height: 1; margin: 2rem 0;">
                                JOIN THE<br>COMMUNITY.</h1>
                            <div
                                style="width: 3rem; height: 4px; background-color: var(--on-primary); margin-bottom: 2rem;">
                            </div>
                            <p style="opacity: 0.8; font-weight: 500; line-height: 1.6;">
                                Access shared resources, track community borrowings, and maintain collective trust in
                                your local neighborhood ecosystem.
                            </p>
                        </div>

                        <div class="branding-notice">
                            <h4>Security Protocol</h4>
                            <p>Registration requires a valid address to ensure neighborhood specific ledger integrity
                    ...
                    <div class="split-form">
                        <div class="mb-8">
                            ...
                            <p
                                style="font-size: 0.875rem; color: var(--outline); margin-top: 0.5rem;margin-bottom:0.7rem">
                                Already a member? <a href="${pageContext.request.contextPath}/user?action=login"
                                    style="color: var(--primary); font-weight: 800; text-decoration: underline;">Login
                                    Here</a>
                            </p>
                        </div>
                        ...
                        <form action="${pageContext.request.contextPath}/user" method="POST"
                            ...
                            <div class="input-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" class="form-input"
                                        placeholder="john@sapati.com" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group mt-8">
                                ...
                                <div style="position: relative;">
                                    <span class="material-symbols-outlined"
                                        style="position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: var(--outline); font-size: 1.25rem;">location_on</span>
                                    <input type="text" id="address" name="address" class="form-input"
                                        style="padding-left: 3rem;" placeholder="e.g. Kathmandu / 123 Main St" required>
                                </div>
                            </div>
                            ...
                            <div class="mt-8 pt-8" style="border-top: 1px dashed var(--outline-variant);">
                                <label style="display: flex; gap: 1rem; cursor: pointer;">
                                    ...
                                    <span
                                        style="font-size: 0.75rem; line-height: 1.6; color: var(--outline);margin-top:0.5rem">
                                        I agree to the <strong style="color: var(--primary);">Terms of Service</strong>
                                        and acknowledge the community late fine policy of NPR 50/day. I understand trust
                                        is our foundation.
                                    </span>
                                </label>
                            </div>
                            ...
                            <div class="mt-8">
                                <button type="submit" class="btn btn-primary"
                                    style="width: 100%; padding: 1.25rem; font-size: 0.75rem; letter-spacing: 0.2em; text-transform: uppercase;margin-top:0.5rem">
                                    Initiate Registration
                                    <span class="material-symbols-outlined"
                                        style="font-size: 1rem; vertical-align: middle; margin-left: 1rem;">arrow_forward</span>
                                </button>
                            </div>
                        </form>

                        <div class="mt-8 grid-3" style="gap: 1rem; opacity: 0.5;">
                            <div style="height: 2px; background-color: var(--outline-variant);">
                                <div style="width: 40%; height: 100%; background-color: var(--primary);"></div>
                            </div>
