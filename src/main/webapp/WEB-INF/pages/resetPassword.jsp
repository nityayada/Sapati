...
<head>
    ...
    <title>Reset Password | Sapati.com</title>
    ...
    <main style="flex: 1; display: flex; align-items: center; justify-content: center; padding: 2rem;">
        <div class="form-container" style="max-width: 450px; width: 100%; box-shadow: 0 10px 25px rgba(0,0,0,0.05);">
            <div class="mb-8 text-center">
                <span class="material-symbols-outlined text-primary" style="font-size: 3rem; margin-bottom: 1rem;">password</span>
                <h2 style="font-size: 1.75rem; font-weight: 900; color: var(--primary); text-transform: uppercase; tracking-tight">New Password</h2>
                <p style="font-size: 0.875rem; color: var(--outline); margin-top: 0.5rem;">
                    Identity verified! You can now set a new secure password for your account.
                </p>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/user" method="POST">
                ...
                <div class="mt-8">
                    <button type="submit" class="btn btn-primary" style="width: 100%; padding: 1.25rem; font-size: 0.75rem; letter-spacing: 0.2em; text-transform: uppercase;">
                        Update Password
                        <span class="material-symbols-outlined" style="font-size: 1rem; vertical-align: middle; margin-left: 1rem;">sync_lock</span>
                    </button>
                </div>
            </form>
        </div>
